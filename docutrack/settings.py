...
SECRET_KEY = 'django-insecure-x#y-+uv*&@^5og!%(_peuz9cuad!-cu6-=$ej4u^=&uj49p&m&'
...
INSTALLED_APPS = [
    ...
    'crispy_bootstrap5',      # Framework CSS opcional
    'docuapp',
]
...
STATIC_URL = '/tramitec/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'static')

LOGIN_URL= '/tramitec/login'
